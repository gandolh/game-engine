// Post-emit fixups for the packable dist/ build of @engine/core.
//
// Why this exists: the engine source uses extensionless, TS-style relative
...
console.log(`[postbuild] rewrote ${rewrites} relative specifiers across ${codeFiles.length} files; copied ${assets} shader asset(s).`);
