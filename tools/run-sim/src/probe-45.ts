...
import { festivalForDay, festivalDayForSeason } from "../../../packages/farm-valley/src/protocols/festival";
import type { GameEntity } from "../../../packages/farm-valley/src/components";
