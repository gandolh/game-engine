...
export const BASE_RECIPES: PixelRecipe[] = [
  ...
  {
    // Shrine flagstone — pale, neatly-laid light-stone slabs with thin dark
    // grout lines, reading as tended sacred ground. q = stone light, Q = stone
    // dark grout, w = cream highlight flecks.
    name: "tile/shrine-floor",
    size: 16,
    pixels: [
      "qqqqqqqQqqqqqqqQ",
      "qqwqqqqQqqqqwqqQ",
  ...
  {
    // Heritage flagstone — worn, moss-streaked old stone (the ground around the
    // ancient relics). Q/q = weathered stone, l = dark moss, G = moss green.
    name: "tile/heritage-floor",
    size: 16,
    pixels: [
      "QQQqQQQQQQqQQQQQ",
      "QQQqQQlGQQqQQGlQ",
  ...
  {
    // Harbor fish basket — a woven creel brimming with the day's catch.
    name: "decoration/fish-basket",
    size: 16,
    pixels: [
      "................",
      ".....sSsSs......",
  ...
  {
    // Quarry rubble — a loose pile of broken stone chunks.
    name: "decoration/rubble",
    size: 16,
    pixels: [
      "................",
      "................",
  ...
  {
    // Mill flour bag — a stout tan sack stamped with a gold mark.
  ...
  {
    // cliff-face-b: offset mortar lines for visual variety
    name: "tile/cliff-face-b",
    size: 16,
    pixels: [
      "kkkkkkkkkkkkkkkk",
      "QQqQQqQQqQQqQQqQ",
  ...
  {
    // cliff-face-left: left-edge corner piece — the leftmost column is a dark
    // shadow seam so the cliff turns the corner on the left side.
    name: "tile/cliff-face-left",
    size: 16,
    pixels: [
      "kkkkkkkkkkkkkkkk",
      "kQqQQqQQqQQqQQqQ",
