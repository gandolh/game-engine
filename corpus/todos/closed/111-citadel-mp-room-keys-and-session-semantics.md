...
source: the 2026-07-10 grilling session, grounded in code read during [brief 108](108-citadel-live-mp-verification.md).
...
- **#16 — rooms are keyed and invite-only.** Peers join `?mp=<roomId>`. Port the Farm `RunRegistry`
  pattern, which [citadel-38 item 7](2026-06-19-citadel-38-implementation-review-problems.md)
