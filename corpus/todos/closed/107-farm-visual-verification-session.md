...
source: pending flags in [wiki/status.md](../../wiki/status.md) ("⚠️ Pending: an in-browser visual pass over 12–16/86/87") + [wiki/animation.md](../../wiki/animation.md) (brief-85 feel-check) + [todos/2026-07-01-citadel-phaseA-playtest-verification.md](2026-07-01-citadel-phaseA-playtest-verification.md) (warm-glow contrast).
