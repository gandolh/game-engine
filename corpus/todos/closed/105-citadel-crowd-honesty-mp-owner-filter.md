...
source: [todos/2026-06-27-citadel-entity-count-matches-population.md](2026-06-27-citadel-entity-count-matches-population.md) — the sim-side leak was fixed (`removeOneVillager` + invariant test); these are the two explicitly-deferred halves.
