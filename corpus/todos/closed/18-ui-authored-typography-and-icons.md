...
source: [todos/closed/2026-06-30-engine-ui-authored-typography-and-icons.md](2026-06-30-engine-ui-authored-typography-and-icons.md) — that todo is the spec (scope 1–4 + acceptance); this brief promotes it into the engine queue and adds sequencing notes.
