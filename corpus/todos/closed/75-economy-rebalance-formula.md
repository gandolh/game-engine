...
- [corpus/briefs/game/done/70-raise-starting-gold-peer-trade-liquidity.md](70-raise-starting-gold-peer-trade-liquidity.md) — the last economy lever (uniform startGold bump); reuse its instrumentation method and its "smallest lever, don't rebalance the arc" discipline.
