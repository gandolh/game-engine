...
status: todo
source: [2026-07-02 review findings items 28–35](2026-07-02-full-repo-review-findings.md) — the file:line detail lives there; verify each against current code first (brief 97's wave may have shifted lines).
...
- **Client niggles** (item 34): `extendTrail` incremental Set; `boxBuilding` `noDoor`
  ...
  handlers.
- **MP iso render window** (item 35) — EXCLUDED here. The [brief 108](108-citadel-live-mp-verification.md)
