...
source: [todos/closed/2026-07-08-engine-audio-subsystem.md](2026-07-08-engine-audio-subsystem.md) — that todo is the problem statement + design constraints + acceptance; this brief adds the dispatch-ready execution plan (shared API contract, three chunks, model routing, waves, gates). Routed via `orchestrate` 2026-07-08; user approved the plan and deferred execution to a later session.
