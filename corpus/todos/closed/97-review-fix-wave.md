...
source: [todos/2026-07-02-full-repo-review-findings.md](2026-07-02-full-repo-review-findings.md) (commit `c2cc78d`) — item numbers below refer to that doc; read it first, it carries the file:line detail and failure scenarios for every item.
