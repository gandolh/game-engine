...
- [wiki/citadel-rendering.md](wiki/citadel-rendering.md) — Citadel's WebGL2 render path: sprite-batch quads, **the tint-alpha trap** that rendered every translucent ground quad opaque, baked terrain, iso projection, road/bridge networks, the 3D-mesh building pipeline, and the atlas/asset wiring.
