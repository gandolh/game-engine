...
- **done/** — briefs 01–48, all shipped (see [briefs/game/done/](briefs/game/done/) for the files and [status.md](wiki/status.md) for per-brief one-liners). Spans personalities, weather/crops, market/shop/auctions, observer UI, regions + travel, peer trades, trust, the camera/leaderboard/playback/seed/decision-trace/event-feed spectator UI, seasons, mid-game shock, day/night grading, long days, AP rework, irrigation, the rendering overhaul + world expansion, player activity, the 36–40 spectator/story layer, the 41–46 depth wave (crop roster + quality, livestock + orchards, greenhouse + skills, working NPCs + tavern, festivals, harbor + contracts), the 47 atlas split, and the 48 boats + coral fishing. Briefs 08/09/10 each have a `*-plan.md` companion alongside the brief.
- **todo/**: [49-organic-procgen-noise-and-authored-detail](briefs/game/todo/49-organic-procgen-noise-and-authored-detail.md) — coherent noise (fBm + domain warp), constructive layout, L-system scatter, authored set-pieces; actionable cut of the [world-generation.md](wiki/world-generation.md) research menu. _Tracks 1, 2, 4 + set-piece props shipped (2026-06-09, see log.md); track 3 deferred; track 5 (L-system) still open._ · [50-interactive-shrine-landmark](briefs/game/todo/50-interactive-shrine-landmark.md) — interactive shrine island (visit→small buff); split out of brief 49 track 6 as a gameplay feature
