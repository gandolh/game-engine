...
- **todo/** (improvement backlog filed 2026-06-12): [10-wasm-pathfinder-allocator-fault](briefs/engine/todo/10-wasm-pathfinder-allocator-fault.md) · [11-wgsl-validation-guard](briefs/engine/todo/11-wgsl-validation-guard.md) · [12-gpu-day-night-wash](briefs/engine/todo/12-gpu-day-night-wash.md) · [13-living-water-shader](briefs/engine/todo/13-living-water-shader.md) · [14-weather-shader-parity](briefs/engine/todo/14-weather-shader-parity.md) · [15-cloud-shadows-and-mist](briefs/engine/todo/15-cloud-shadows-and-mist.md) · [16-foliage-wind-sway](briefs/engine/todo/16-foliage-wind-sway.md) — 12/13/15 form a dependency chain (wash first); 13–16 promoted from [wiki/shader-ideas.md](wiki/shader-ideas.md). *(The unnumbered `todo/webgpu/` wave-plan dir belongs to the shipped WebGPU migration — pending move to done/ by its owning session.)*

### Game

Game briefs **01–84 are shipped**; **`todo/`**: [85-animation-engine](briefs/game/todo/85-animation-engine.md) (reintroduce the `AnimationClip`/`Animator` primitive with real consumers + an action swing for working farmers/Pip; render-only — see [wiki/animation.md](wiki/animation.md)) · [86-juice-and-floating-numbers](briefs/game/todo/86-juice-and-floating-numbers.md) (Tier-3 game-feel backlog: popups, shake, hitstop, score-bump) · [87-home-forge-house-restyle](briefs/game/todo/87-home-forge-house-restyle.md) (finish the Stardew restyle leftover) · [88-deploy-real-vps-verification](briefs/game/todo/88-deploy-real-vps-verification.md) (close the dry-run-only deploy gap; needs user/VPS) · [89-detailed-characters-and-held-tools](briefs/game/todo/89-detailed-characters-and-held-tools.md) (24×24 character art + selected hotbar tool in hand via a pixel-safe overlay; design agreed, awaiting build sign-off — render-only). Per-brief one-liners in [status.md](wiki/status.md); done files in [briefs/game/done/](briefs/game/done/). Coverage by range:
