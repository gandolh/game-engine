...
- **todo/** — the rest of the **"more islands" theme** (landmark + special islands that break the archipelago's symmetry; user request 2026-06-09; pattern set by the shipped briefs 50/51/52): [53-remote-bar-gold-for-ap](briefs/game/todo/53-remote-bar-gold-for-ap.md) (gold→AP — ⚠️ overlaps the existing brief-44 tavern; scope decision first) · [54-camping-rest-island](briefs/game/todo/54-camping-rest-island.md) (rest away from home without the unrested penalty)
