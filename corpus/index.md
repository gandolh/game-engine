...
- **todo/**: [70-raise-starting-gold-peer-trade-liquidity](briefs/game/todo/70-raise-starting-gold-peer-trade-liquidity.md) · [71-per-asset-recipe-files-and-cached-atlas-builds](briefs/game/todo/71-per-asset-recipe-files-and-cached-atlas-builds.md) — split the recipe monolith into one file per asset + hash-cached per-sheet atlas builds; research in [wiki/asset-pipeline.md](wiki/asset-pipeline.md)
