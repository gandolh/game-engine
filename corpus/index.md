...
- **todo/**: [50-interactive-shrine-landmark](briefs/game/todo/50-interactive-shrine-landmark.md) — interactive shrine island (visit→small buff); split out of brief 49 track 6 as a gameplay feature deserving its own design
