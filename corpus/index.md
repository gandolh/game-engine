...
- **66–79** — tab-resync (66), camera smoothing (67), ambient life (68), named system stages (69), startgold bump (70), per-asset atlas recipes (71), shared-run lobby server (72), travel-reachability guards (73), weather-station island (74), economy rebalance (75), loading screen (76), building 3D + farmhouses (77), Pip-movement not-reproducible (78), click-to-target + action cursor (79).
