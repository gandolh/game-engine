...
- [briefs/game/todo/46-harbor-shipping-and-contracts.md](briefs/game/todo/46-harbor-shipping-and-contracts.md) — a harbor + time-boxed contracts + reputation: a demand-driven new playstyle axis (and a soft fix for the fixed-price-shop flatness). **The last todo.**
