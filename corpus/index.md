...
- **todo/**: [49-organic-procgen-noise-and-authored-detail](briefs/game/todo/49-organic-procgen-noise-and-authored-detail.md) — coherent noise (fBm + domain warp), constructive layout, L-system scatter, authored set-pieces; actionable cut of the [world-generation.md](wiki/world-generation.md) research menu
