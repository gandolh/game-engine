...
> - **Next / open:** re-check in-browser (carried can size/position now; do hoe/axe/pickaxe — upright icons scaled 0.6 — also read OK held?). Remaining deferred: **24px action poses** (still 16px) + re-drawing the tool sprites at 24-matched detail. Once the feel-check passes, brief 89 closes to done/.
